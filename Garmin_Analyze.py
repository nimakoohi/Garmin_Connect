...
def connect_to_database():
    ...
    if db_manager.establish_connection():
        ...
        return(times, time_column, heart_rate_column, speed_column, cadence_column, altitude_column, db_manager, save_directory)

    return None  # Return None if the connection is not established


def Plotting(time_column, heart_rate_column, speed_column, cadence_column, altitude_column, save_directory, name, total_km_result, types_of_runs, times):
...
def main():
    ...
    times, time_column, heart_rate_column, speed_column, cadence_column, altitude_column, db_manager, save_directory = connect_to_database() 
    ...
    Plotting(time_column, heart_rate_column, speed_column, cadence_column, altitude_column, save_directory, name, total_km_result, types_of_runs, times)
